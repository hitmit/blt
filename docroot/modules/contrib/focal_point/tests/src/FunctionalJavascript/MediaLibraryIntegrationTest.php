...
class MediaLibraryIntegrationTest extends WebDriverTestBase {
  ...
  public function testFocalPointMediaField() {
    ...
    // The preview link should be present, but it should not be using a modal
    // dialog via AJAX.
    $assert_session->elementExists('css', '.focal-point-preview-link[target="_blank"]:not(.use-ajax[data-dialog-type])');
  }
