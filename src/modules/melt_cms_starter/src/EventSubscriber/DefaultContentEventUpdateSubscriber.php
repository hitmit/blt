...
namespace Drupal\melt_cms_starter\EventSubscriber;
...
class DefaultContentEventUpdateSubscriber implements EventSubscriberInterface {
   ...
   *
   * @var \Drupal\melt_cms_event\DefaultContentEventUpdate
   */
   ...
   * Constuctor.
   *
   * @param \Drupal\melt_cms_event\DefaultContentEventUpdate $update_event_import
   *   The config factory.
   */
