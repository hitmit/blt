 ...
 * @endcode
 */
$settings['hash_salt'] = 'y3Ie8VrZEGbMmK6n2vCMCQmz92oIqoHpRGuOavU7WbNIAJnIcceuhAq-bmACEMKo8UkjNFiJpg';
 ...
 */
#
$config_directories['sync'] = '../config'; # Drupal <= 8.7
$settings['config_sync_directory'] = '../config'; # Drupal >= 8.8

$settings['cognito'] = [
  'region' => 'us-west-2',
  'profile' => '<INSERT PROFILE NAME>',
  'user_pool_id' => '<INSERT USER POOL ID>',
...
// See https://cohesiondocs.acquia.com/6.4/user-guide/version-6-4-0-release-details
$settings['rebuild_max_entity'] = 50;$databases['default']['default'] = array (
  'database' => 'drupal9',
  'username' => 'drupal9',
  'password' => 'drupal9',
  'prefix' => '',
